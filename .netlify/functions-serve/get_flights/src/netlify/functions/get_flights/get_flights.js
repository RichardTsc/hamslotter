...
// netlify/functions/get_flights/get_flights.js
var fetch2;
Promise.resolve().then(() => (init_src(), src_exports)).then((module2) => {
  fetch2 = module2.default;
});
exports.handler = async function(event, context) {
  if (event.httpMethod !== "GET") {
    return { statusCode: 405, body: "Method Not Allowed" };
  }
  const apiUrl = "https://slotandfly.cloud.ham.aero/api/flugdaten/2023-08-25";
  try {
...
//# sourceMappingURL=get_flights.js.map
